...
export const metadata = {
  title: "PING G430 MAX vs Qi4D  比較｜どっちがおすすめ？",
description:
  "PING G430 MAXとQi4D を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function G430MaxVsQi4DPage() {
  return (
