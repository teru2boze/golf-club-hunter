...
export const metadata = {
  title: "PING G440 MAX vs G430 MAX  比較｜どっちがおすすめ？",
description:
  "PING G440 MAXとG430 MAX を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
...
<div className="rounded-xl bg-gray-50 p-4">
  <h3 className="text-xl font-bold">G430 MAX がおすすめな人</h3>
  <p className="mt-2">
    ミスへの強さと安定感を最優先したい人。
