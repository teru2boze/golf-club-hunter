...
export const metadata = {
  title: "PING G440 MAX vs ELYTE X  比較｜どっちがおすすめ？",
description:
  "PING G440 MAXとELYTE X を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function G440MaxVsElyteXPage() {
  return (
