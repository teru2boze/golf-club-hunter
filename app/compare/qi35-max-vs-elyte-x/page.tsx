...
description:
  "Qi35 MAXとELYTE X を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function Qi35MaxVsElyteXPage() {
  return (
...
alt="Qi35 MAX"
    ...
    />
    <p className="mt-2 font-bold">Qi35 MAX</p>
  </div>
