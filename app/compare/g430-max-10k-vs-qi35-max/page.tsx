...
description:
  "Qi35 MAXとG430 MAX 10Kを飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function G430Max10KVsQi35MaxPage() {
  return (
  ...
  Qi35 MAXとG430 MAX 10Kの違いを徹底比較します。
