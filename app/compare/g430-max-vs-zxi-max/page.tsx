...
export const metadata = {
  title: "PING G430 MAX vs ZXi MAX  比較｜どっちがおすすめ？",
description:
  "PING G430 MAXとZXi MAX を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function G430MaxVsZxiMaxPage() {
  return (
    <main className="min-h-screen bg-green-50 px-4 py-10">
      <div className="mx-auto max-w-3xl rounded-2xl bg-white p-6 shadow">
        <h1 className="text-3xl font-bold text-green-800">
  PING G430 MAX vs ZXi MAX 
</h1>

        <p className="mt-4 text-gray-700">
  PING G430 MAXとZXi MAX を比較します。
