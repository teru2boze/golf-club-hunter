...
export const metadata = {
  title: "PING G430 MAX vs GT2  比較｜どっちがおすすめ？",
description:
  "PING G430 MAXとGT2 を飛距離・やさしさ・操作性で比較。どちらがおすすめかをわかりやすく解説します。",
};
export default function Qi4DvsQuantumMaxPage() {
  ...
  PING G430 MAX vs GT2 
</h1>

        <p className="mt-4 text-gray-700">
  PING G430 MAXとGT2 を比較します。
...
alt="TaylorMade GT2"
  className="mx-auto h-48 w-full object-contain"
/>
<p className="mt-2 font-bold">TaylorMade GT2</p>
  </div>
</div>
